...
author: shui861wy (https://sketchfab.com/shui861wy)
license: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
source: https://sketchfab.com/3d-models/3deditorchallenge-littlest-tokyo-cb60fd7ad9ce4841bb92d8725154b7ce
title: 3DEditorChallenge: Littlest Tokyo
*/
...
export function Tokyo(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF('/tokyo.gltf');
  const { actions } = useAnimations(animations, group);
  console.log(actions);
  useEffect(() => {
    /* highlight-line */
    actions['Take 001'].play(); /* highlight-line */
  });
  return (
